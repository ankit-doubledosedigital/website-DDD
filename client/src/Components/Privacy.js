...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-container">
      ...
      <p>
        We collect information that you provide to us directly, such as when you register on our site, place an order, subscribe to our newsletter, respond to a survey, fill out a form, or use certain other site features.
      </p>
      ...
      <p>This policy was last modified on [date].</p>
      <h2>Contacting Us</h2>
      <p>
        If there are any questions regarding this privacy policy, you may contact us using the information below:
      </p>
      <p>
        Double Dose Digital Private Limited<br />
        [Address]<br />
        [Email Address]<br />
        [Phone Number]
      </p>
